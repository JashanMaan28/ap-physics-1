        ...
        <ClientOnly>
          {_values.map((_, index) => (
            <SliderPrimitive.Thumb
              ...
              key={index}
              index={index}
              className="relative block size-5 shrink-0 rounded-full border-2 border-primary bg-background shadow-sm ring-ring/50 transition-[color,box-shadow,transform] select-none after:absolute after:-inset-2 hover:scale-110 hover:ring-4 focus-visible:ring-4 focus-visible:outline-hidden active:scale-95 active:ring-4 disabled:pointer-events-none disabled:opacity-50"
            />
          ))}
        </ClientOnly>
